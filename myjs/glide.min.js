  ...
  var J = {
      ...
      Controls: function (t, e, n) {
        var i = new R(),
          ...
          o = {
            mount: function () {
              (this._n = e.Html.root.querySelectorAll('[data-glide-el="controls[nav]"]')), (this._c = e.Html.root.querySelectorAll(N)), (this._arrowControls = { previous: e.Html.root.querySelectorAll(Y), next: e.Html.root.querySelectorAll(X) }), this.addBindings();
            },
            setActive: function () {
